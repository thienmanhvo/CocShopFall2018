<%-- 
    Document   : insertprod.jsp
    Created on : Dec 16, 2018, 12:48:21 PM
    Author     : benfi
--%>
        ...
        <div id="mainWrapper">
            ...
            <div class="register animate-bottom-offer">
                ...
                <center>
                    ...
                    <p style="font-size: 20px">Insert product here.</p>
                </center>
                                ...
                                <div style="display: flex">
                                    <div style="width: 50%">
                                        ...
                                        Product Name: <s:textfield name="productName"  theme="simple" placeholder="Product Name:" cssClass="textFieldChangePass"
                                                                   value="%{#request.PRODUCT.productName}"/>
                                        ...
                                        Price Sell:  <s:textfield name="priceSell"  theme="simple" placeholder="Price Sell:" cssClass="textFieldChangePass"
                                                                  value="%{#request.PRODUCT.priceSell}" type="number"/>
                                    ...
                                    <div style="width: 50%">
                                        ...
                                        Price In:  <s:textfield name="priceIn"  theme="simple" placeholder="Price In:" cssClass="textFieldChangePass"
                                                                value="%{#request.PRODUCT.priceIn}" type="number"/>
                                        ...
                                        Quantity: <s:textfield name="quantity"  theme="simple" placeholder="Quantity:" cssClass="textFieldChangePass" 
                                                               value="%{#request.PRODUCT.quantity}" type="number"/>
                                        ...
                                        Price Sale:<s:textfield name="priceSale"  theme="simple" placeholder="Price Sale:" cssClass="textFieldChangePass"
                                                                value="%{#request.PRODUCT.priceSale}" type="number"/>
                                        ...
                                        <div style="display: flex;margin-top: 2%">
                                            <div style="float: left;margin: 2% 10% 2% 10%;">
                                                IsNew:
                                                <s:select list="list" headerKey="0" theme="simple" name="isNew" value="isNew" cssStyle="font-size: 17px;"/>
                                            </div>
                                            <div style="float: left;margin: 2% 10% 2% 10%;">
                                                IsBest:
                                                <s:select list="list" headerKey="0" theme="simple" name="isBest" value="isBest" cssStyle="font-size: 17px;"/>

                                            </div>
                                            <div style="float: left;margin: 2% 10% 2% 10%;">
                                                IsSale:
                                                <s:select list="list" headerKey="0" theme="simple" name="isSale" value="isSale" cssStyle="font-size: 17px;"/>
                                            </div>
                                        </div>
