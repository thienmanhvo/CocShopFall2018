<%-- 
    ...
    Created on : Dec 16, 2018, 11:00:59 PM
    Author     : benfi
--%>
...
<html>
    ...
    <body class="bg">
        <div id="mainWrapper">
            ...
            <div id="login" class="animate-bottom-offer" style="height: 300px">
                <p class="center" style="padding-top: 50px;"><a href="index.jsp">Trang chủ</a> /  Đăng nhập</p>
                <div class="wrap-form">	
                    <center>
                        <div>
                            <h2 style="width: 30%;color: green">Check out Successfully</h2>
                            <h3>You can't continue shopping to continue!</h3>
                        </div>
                    </center>  
                </div>
            </div>
